    ...
    <>
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .kpi-card .sub { font-size: 8pt; font-weight: 600; margin-top: 4px; }
        ...
        @media print { .print-btn { display: none !important; } body { font-size: 10pt; } }
      `}</style>
        ...
        <div className="section">
          ...
          <div className="budget-grid">
            <div className="budget-box">
              <div className="num">{formatCurrency(budget.total || 0)}</div>
              <div className="lbl">Toplam Bütçe</div>
            </div>
            <div className="budget-box">
              <div className="num">{formatCurrency(budget.avg || 0)}</div>
              <div className="lbl">Ortalama Bütçe</div>
            </div>
            <div className="budget-box">
              <div className="num">{formatCurrency(budget.max || 0)}</div>
              <div className="lbl">En Yüksek Bütçe</div>
            </div>
          </div>
        </div>
            ...
            {byType.map((t: any, i: number) => {
              ...
              return (
                <div key={i} className="status-row">
                  ...
                  <div className="status-bar-bg">
                    <div className="status-bar" style={{ width: `${pct}%`, background: '#1a3a6b' }} />
                  </div>
              ...
              {byFaculty.map((f: any, i: number) => {
                ...
                return (
                  <div key={i} className="status-row">
                    ...
                    <div className="status-bar-bg">
                      <div className="status-bar" style={{ width: `${pct}%`, background: '#c8a45a' }} />
                    </div>
