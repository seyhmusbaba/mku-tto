...
function ThemeToggle() {
  ...
  useEffect(() => { setThemeLocal(getTheme()); }, []);
  return (
    <button onClick={() => setThemeLocal(toggleTheme())}
      className="w-9 h-9 rounded-xl flex items-center justify-center transition-colors hover:bg-cream"
